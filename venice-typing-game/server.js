...
function createRoom(roomId, mode, label) {
  ...
  function applyAnswer(p, correct) {
    ...
    emitRoom('answerResult', { id: p.id, correct, row: p.row, wrongCount: p.wrongCount, eliminated: p.eliminated });
  }
  ...
  return { state, join, startGame, submitAnswer, pauseGame, resumeGame, restartMidGame, restartGame, requestRanking, handleDisconnect };
}
